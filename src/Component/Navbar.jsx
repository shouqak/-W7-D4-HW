        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            {username ? (
              ...
              <>
                <Link to="/login"  className="block bg-amber-500 hover:bg-amber-700 text-white font-bold py-2 px-4 rounded">
                  Login
                </Link>
                <Link to="/register" className="bg-amber-800 hover:bg-amber-900  font-semibold text-white py-2 px-4 border border-amber-500 hover:border-transparent rounded">
                  Register
                </Link>
              </>
            )}
